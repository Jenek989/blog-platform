    ...
    <article className={classes.article}>
      <div className={classes.articleWrapper}>
        <div className={classes.articleMain}>
          ...
          <Paragraph className={classes.articleDescription}>{getShortedOverview(article.description, 225)}</Paragraph>
        </div>
        <div className={classes.articleWrapperInfo}>
          ...
          <Image width={40} height={40} src={article.author.image} alt="avatar" fallback={fallback}></Image>
        </div>
      </div>
    </article>
  );
