    ...
    <article className={classes.article}>
      <div className={classes.articleWrapper}>
        ...
        <div className={classes.articleWrapperInfo}>
          ...
          {singlePage && username === article.author.username ? (
            <div className={classes.articleSingleButton}>
              <Popconfirm
                description="Are you sure to delete this article?"
                onConfirm={onClickDeleteArticle}
                cancelText="No"
                okText="Yes"
              >
                <Button className={classes.newArticlebuttonTag} type="primary" danger ghost>
                  Delete
                </Button>
              </Popconfirm>
